...
<div class="normal-area normal-area--button-set-bottom">
  <div class="kw-stepper-headingtext">
    <kw-stepper
      ...
      class="has-search"
    >
    <!-- if there is no kw-search inside kw-stepper, please remove class="has-search" -->
      <kw-step
        :name="1"
        title="step1"
        :done="stepInitNum > 1"
      ...
      >
        ...
        <kw-tab-panels model-value="1">
          <kw-tab-panel name="1">
            <div class="over-width">
              <!-- if there is no need kw-search, please remove class="over-width"-->
              <kw-search>
                <kw-search-row>
                  <kw-search-item label="abc">
                    <kw-input />

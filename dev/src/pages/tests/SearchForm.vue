<template>
  <kw-page>
    ...
    >
      <kw-search-row>
        <kw-search-item label="인풋입력해주세 인풋입력해주세">
          <kw-input
            name="input"
            rules="required"
            placeholder="입력해주세요"
